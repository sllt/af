...
func TestMustShutdownWithContext(t *testing.T) {
	...
	is.PanicsWithError("DI: could not find service `*github.com/sllt/af/di.lazyTestShutdownerKOCtx`, no service available", func() {
		MustShutdownWithContext[*lazyTestShutdownerKOCtx](ctx, i)
	})
}
...
func TestDoubleInjection(t *testing.T) {
	...
	is.PanicsWithError("DI: service `*github.com/sllt/af/di.test` has already been declared", func() {
		Provide(i, func(i Injector) (*test, error) {
			return &test{}, nil
		})
	})
	...
	is.PanicsWithError("DI: service `*github.com/sllt/af/di.test` has already been declared", func() {
		ProvideNamed(i, "*github.com/sllt/af/di.test", func(i Injector) (*test, error) {
			return &test{}, nil
		})
	})

	is.PanicsWithError("DI: service `*github.com/sllt/af/di.test` has already been declared", func() {
		ProvideNamedValue(i, "*github.com/sllt/af/di.test", &test{})
	})
}
