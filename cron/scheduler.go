...
var defaultScheduler = NewScheduler(time.Local)
...
// it through cron is to use DoWithJobDetails and access the job's Context which
...
// The last argument of the function must be a cron.Job that will be passed by
